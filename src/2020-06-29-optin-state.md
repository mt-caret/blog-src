...
can act as an escape hatch to get some software working quickly on your machine.
...
EDIT 2020-01-26: Added persistence for `/etc/machine-id`, which fixes an issue
where journalctl fails to find logs from past boots, among various others.
Thanks j-hui for pointing this out!
